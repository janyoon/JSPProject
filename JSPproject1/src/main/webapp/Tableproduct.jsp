...
<body>
	...
	<main class="container">
		...
		<div
			style="border: 1px; margin: 200px 30px 0px; float: left; width: 400px;">
			<div class="fw-bold fs-3">글자넣자 글자</div>
			<p>"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
				do eiusmod tempor incididunt ut labore et dolore ma gna aliqua. Ut
				enim ad minim veniam, quis nostrud exer citation ullamco laboris
				nisi ut aliquip ex ea commodo co nsequat. Duis aute irure dolor in
				reprehenderit in volupta te velit esse cillum dolore eu fugiat nulla
				pariatur. Except eur sint occaecat cupidatat non proident, sunt in
				culpa q ui officia deserunt mollit anim id est laborum."</p>
		</div>
	</main>
			...
			<div class="col-sm-4">
				<div style="align-items: flex-end; width: 160px; height: 160px;">
					<img src="./upload2/<%=rs.getString("p_filename")%>"
						style="width: 150px; height: auto;" class="">
				</div>
