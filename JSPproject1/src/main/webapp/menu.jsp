      	...
      	<c:choose>
			...
			<c:otherwise>
				<li style="padding-top: 7px; color: white">[<%=sessionId%>님]</li>
					...
					<li class="nav-item"><a class="nav-link text-white" href="<c:url value="/member/updateMember.jsp"/>">회원 수정</a></li>
			</c:otherwise>
		</c:choose>
      </ul>
    </div>
      ...
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        ...
        <div class="dropdown text-end">
            ...
            <ul class="dropdown-menu text-small">
              <li><a class="dropdown-item" href="Chairproduct.jsp">Chair</a></li>
              <li><a class="dropdown-item" href="Tableproduct.jsp">Table</a></li>
              <li><a class="dropdown-item" href="Sofaproduct.jsp">Sofa</a></li>
            </ul>
          </div>
        ...
        <form class="col-12 col-lg-auto mb-3 mb-lg-0" role="search">
          ...
          <div class="dropdown text-end">
            ...
            <ul class="dropdown-menu text-small">
              <li><a class="dropdown-item" href="addProduct.jsp">제품 등록</a></li>
              <li><a class="dropdown-item" href="editProduct.jsp?edit=update">제품 수정</a></li>
              <li><a class="dropdown-item" href="editProduct.jsp?edit=delete">제품 삭제</a></li>
